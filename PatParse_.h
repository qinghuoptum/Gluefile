...
#define MAXNUMFLDS      200
#define MAXRPTLEN       64000
#define	MAXKEYLEN		32
...
public:
	...
	//
    LPTSTR SetAllText  ( LPTSTR pszTmplt, LPTSTR pszBuf, int nLen, LPTSTR pszBody = NULL,
					     int nCriteria=0 );
	//  Add Extra manipulation on Current Record
	void ExtraManipulate( LPCTSTR pszOperStmt );
	// Selection format: ${<Item>=<Criteria>|...|}
	bool SelectPropItem( LPTSTR pszTmplt, LPTSTR pszBuf, int nLen );
...
static char gTitleList[MAX_TITLE][8] = { "PA-C","CF-A","PHD","PhD","MD","DDS","LCSW","MFCC",
									"MSW","DO","OD","DPM","RPT","COT","CNM","CNIM",
									"R#1","R#2","R#3","R#4","LAC","RN","DR","CRNP","CNRP",
									"A/ANP","ACNP","ANP-C","BSN","CCIV","DMD","FNP","FELLOW",
									"MS","CPE","FACS","JD","CM","FRCPC","FACS","FACSC",
									"FCP","CGC","CNP","FNPC","NP","NPC","MSN","ND",
									"RNFA","OT","PT","PA","PAS","STU","RDH","BSN",
									"OCN","RPA-C","WHNP","RNFA","ANP","MBBS",
									"MSN","MD-FCP","NP-C","MSNP","ST","CRS",
									"RN-BSN","RPA-C","FCCP","R-1","R-2","R-3","R-4","\0" };
